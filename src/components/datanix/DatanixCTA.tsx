    ...
    <section className="section-padding bg-elevate-darkBg relative overflow-hidden">
      ...
      <div className="container-custom relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="heading-lg mb-4">Ready to Harness Your Data?</h2>
          <p className="text-body mb-8 max-w-2xl mx-auto">
            Contact us to explore how DATANIX can help you transform data into actionable insights and drive organizational success.
          </p>
